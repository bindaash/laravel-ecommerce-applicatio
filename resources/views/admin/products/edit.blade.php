                            ...
                            <div class="tile-body">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback active">
                                        <i class="fa fa-exclamation-circle fa-fw"></i>@if (!empty($message)) @error('name') <span>{{ $message }}</span> @enderror @endif
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            />
                                            <div class="invalid-feedback active">
                                                <i class="fa fa-exclamation-circle fa-fw"></i>@if (!empty($message)) @error('sku') <span>{{ $message }}</span> @enderror @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="invalid-feedback active">
                                                <i class="fa fa-exclamation-circle fa-fw"></i>@if (!empty($message)) @error('brand_id') <span>{{ $message }}</span> @enderror @endif
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            />
                                            <div class="invalid-feedback active">
                                                <i class="fa fa-exclamation-circle fa-fw"></i>@if (!empty($message)) @error('price') <span>{{ $message }}</span> @enderror @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            />
                                            <div class="invalid-feedback active">
                                                <i class="fa fa-exclamation-circle fa-fw"></i>@if (!empty($message)) @error('quantity') <span>{{ $message }}</span> @enderror @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
